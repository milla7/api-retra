               ...
               <tbody>
                  <tr>
                     <td align="center">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="20" >
                           <tr>
                              ...
                              <h1 style="text-align:center;font-family:Arial, Helvetica, sans-serif;font-size:24px;font-weight:normal;margin:30px 0;padding:0">
                                      Notificación de restablecimiento de contraseña</h1>
                                 <p style="font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-align:center;">Para cambiar la contrase&ntilde;a, haz clic en el siguiente boton</p>
                        ...
                        <br><br>
                        <div align="center">
                                          <a href="{{$link}}" style="background-color:#000;border-radius:5px;color:#ffffff;display:inline-block;font-family:Arial, Helvetica, sans-serif;font-size:12px;font-weight:500;line-height:50px;text-align:center;text-decoration:none;width:200px" target="_blank">Recuperar</a>
                                       </div>
